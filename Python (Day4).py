...
Organisating the list datatype:


# In[2]:


cars= ["BMW","KIA","BENZ","SUSUKI","AUDI","TOYOTA"]
print(cars)
type(cars)
...
# i want to organise the list in alphabrtical order
There are 2 types of approch:
    1. Temp app= Sorted = The order is impliend temporary
    2. Permanet App= Sort= Permanent changes are made in a list
...
# Interview Q: Whats the difference between Sort and Sorted?


# In[5]:


# How to reverse a list permanently
cars.reverse()
print(cars)
...
# Want to count the total numbers of elements in the list:
print("Total no. of elements in the list are:")
len(cars)
...
#Note: Stop_values will be always exculsive, to inculde we have to increment the index by +1

student1= ['Mustafa','Aaron','Varad','Harsh','Akshay','Fardin']
print(student1)
...
#Slicing the list Student1 temporary
print(student1[0:3])
print(student1[0:6:3])
